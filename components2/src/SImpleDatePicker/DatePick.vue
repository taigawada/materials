            ...
            >
                <td
                    ...
                    :class="{
                        ...
                        calender_data_selected: highLightsOrSelected(day),
                    }"
                    :style="pointer"
...
export default defineComponent({
    ...
    setup(props) {
        ...
        const parseWeekboolean = ref<[number, number][]>([]);
        watchEffect(() => {
            ...
            parseWeekboolean.value = parseResult;
        });
        const highLightsOrSelected = (date: Date) =>
            parseWeekboolean.value.find(
                (elememt) =>
                    elememt[0] ===
        ...
        const showDateString = () => {
            return format(currentShowDate.value, 'yyyy年MM月');
        };
